...
#' @name boys7482
#' @docType data
#' @format A data frame with 7,482 rows and 9 variables:
#' \describe{
...
#' (2000). Body index measurements in 1996-97 compared with 1980. *Archives of
#' Disease in Childhood*, 82, 107-112.
#'
#' @references Stef van Buuren (2012).
#'
#' @keywords datasets
#'
#' @examples
